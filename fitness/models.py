...
class Booking(models.Model):
    ...
    user_email = models.EmailField(max_length=150, null=False, blank=False)
    user_contact = models.CharField(max_length=20, null=False, blank=False)
    booking_date = models.DateField(default=datetime.now, null=False, blank=False)
    message = models.TextField(null=True, blank=True)
    status = models.CharField(max_length=50, default="Pending")  # Pending, Confirmed, Cancelled

    def __str__(self):
        return f"Booking for {self.trainer.trainer_name} by {self.user_name}"

class course_buy(models.Model):
    id = models.AutoField(primary_key=True)  # Create an AutoField primary key
    name = models.CharField(max_length=100,null=False,blank=False)
    country = models.CharField(max_length=100,null=False,blank=False)
    Therapy_date = models.DateField(null=False,blank=False)
    ...
    Therpay_name= models.ForeignKey(course, on_delete=models.CASCADE)
